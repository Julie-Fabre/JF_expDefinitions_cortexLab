function vanillaChoiceworldImgs(t, events, parameters, visStim, inputs, outputs, audio)
...
% Reward
rewardSize = parameters.rewardSize;
...
trialDataInit.stimName = ['zserver.cortexlab.net\Data\pregenerated_textures\JulieF\choiceWorld_7StimsNew\img1.jpeg']; %QQ
end
...
trialData.imgN = randi(8, [1,1]);
clown = imread(['\\zserver.cortexlab.net\Data\pregenerated_textures\JulieF\choiceWorld_7StimsNew\img', num2str(trialData.imgN), '.jpeg']);
