function choiceWorldJF_kilotrode(t, events, p, visStim, inputs, outputs, audio)
...
p.startingAzimuth = 90; % (degrees)
p.responseDisplacement = 90; % (degrees)
...
% Timing
p.prestimQuiescentTime = 0.5; % (seconds)
