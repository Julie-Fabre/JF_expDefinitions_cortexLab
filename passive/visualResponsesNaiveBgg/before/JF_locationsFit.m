function JF_locationsFit(t, events, parameters, visStim, inputs, outputs, audio)
...
% % Visual
imgDir = '\\zserver\Data\pregenerated_textures\JulieF\locations';
...
stim.azimuth = 0;
stim.dims = [300,90]; %y*x dimensions. 
