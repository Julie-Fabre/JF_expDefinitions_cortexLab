function JF_locationsFitVarITIGrating(t, events, parameters, visStim, inputs, outputs, audio)
...
% % Visual
imgDir = '\\zserver.cortexlab.net\Data\pregenerated_textures\JulieF\locationsGratings\';
