function JF_GratingPassiveVarITI_moreCombnew(t, events, parameters, visStim, inputs, outputs, audio)
...
% Visual stim
sigma = [20,20];
azimuths = repmat([-90,0,90],1,32);
contrasts = repmat([1],1,32);
spatialFreq = repmat([1/3.25,1/3.25,1/3.25,1/3.25,1/3.25,1/3.25,1/3.25,1/3.25,...
    1/7.5,1/7.5,1/7.5,1/7.5,1/7.5,1/7.5,1/7.5,1/7.5,...
1/15,1/15,1/15,1/15,1/15,1/15,1/15,1/15,...
1/30,1/30,1/30,1/30,1/30,1/30,1/30,1/30,...
1/60,1/60,1/60,1/60,1/60,1/60,1/60,1/60],1,3);
orientations= sort(repmat([0,22.5, 45,67.5, 90,-22.5,-45,-67.5], 1,12));
