function vanillaChoiceworldDiffNameSignalsSucks(t, events, parameters, visStim, inputs, outputs, audio)
...
trialDataInit.stimName = ['zserver.cortexlab.net\Data\pregenerated_textures\JulieF\choiceWorld_7Stims\img2.jpeg'];
end
...
clown = imread(['\\zserver.cortexlab.net\Data\pregenerated_textures\JulieF\choiceWorld_7Stims\img',num2str(randi(7,[1, 1])),'.jpeg']);
