function choiceWorldrewNoGoJF2(t, events, p, visStim, inputs, outputs, audio)
...
wheelGainNoGo = p.noGoGain; 
wheelGainNoGo = p.normalGain; 
% Sounds
...
trialDataInit = events.expStart.mapn(...
    ...
    trialsToBuffer, trialsToZeroContrast, rewardSize, wheelGainNoGo,wheelGain,...
...
wheelGain = iff( trialDataInit.trialOrientation == 45, wheelGainNoGo,wheelGain);
...
wheelGain = iff( trialData.trialOrientation == 45, wheelGainNoGo,wheelGain);
...
events.wheelGainNoGo = wheelGainNoGo;
%% Defaults
try 
    p.rewardKey='r';
...
function trialDataInit = initializeTrialData(expRef, ...
    ...
    trialsToZeroContrast,rewardSize, wheelGainNoGo, wheelGain)
...
trialDataInit.wheelGainNoGo=wheelGainNoGo; 
