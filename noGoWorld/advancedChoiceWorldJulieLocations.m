function advancedChoiceWorldJulieLocations(t, evts, p, vs, in, out, audio)
%% advancedChoiceWorld
...
stimName = imread(['\\zserver.cortexlab.net\Data\pregenerated_textures\JulieF\choiceWorld_7Stims\img4.jpeg']);

% Test stim left
leftStimulus = vis.image(t); 
leftStimulus.sourceImage = stimName;

% leftStimulus = vis.grating(t, 'rectangle', 'gaussian'); % create a Gabor grating
...
rightStimulus.sourceImage = stimName;
rightStimulus.altitude = 0;
rightStimulus.dims = [90, 90]; 
