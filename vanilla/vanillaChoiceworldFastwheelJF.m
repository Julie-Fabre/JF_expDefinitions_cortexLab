function vanillaChoiceworldFastwheelJF(t, events, parameters, visStim, inputs, outputs, audio)
...
% Reward
rewardSize = 3; % 191004 Changed from 2 to 4. %JF 221029=019 changed from 4 to 3. 
