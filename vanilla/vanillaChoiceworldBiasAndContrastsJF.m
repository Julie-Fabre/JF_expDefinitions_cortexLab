function vanillaChoiceworldBiasAndContrastsJF(t, events, parameters, visStim, inputs, outputs, audio)
...
% Reward
rewardSize = 3; %QQ changed from 2 20191023 JF
staircaseTrials=2;
staircaseHits=3;
staircaseMiss=1;
