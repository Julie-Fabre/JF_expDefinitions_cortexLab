function vanillaChoiceworldBiasJF(t, events, parameters, visStim, inputs, outputs, audio)
...
% Reward
rewardSize = 2.0; %QQ changed from 2 20191023 JF
...
onsetToneSamples = onsetToneAmplitude*...
    mapn(onsetToneFreq, 0.1, audioDevice.DefaultSampleRate,...
