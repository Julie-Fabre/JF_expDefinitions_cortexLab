function vanillaChoiceworldAllStim(t, events, parameters, visStim, inputs, outputs, audio)
...
current_min_contrast = min(trialData.contrasts(trialData.startContrasts & trialData.contrasts ~= 0));
